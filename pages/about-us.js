                            ...
                            <div className="col-lg-6">
                                <div className="about-item">
                                    <div className="about-content">
                                        ...
                                        <h3>Over 5 years Professional Experience</h3>
                                        <p>We have been making positive changes for over 5 years especially in the education sectore. We view ourselves as a leader in education technologies and workplace transformations in Southern Africa.
                                        Through our partnership with Google, we deliver customized technology and innovation solutions to more than 80  institutions.</p>
                                    </div>

                                    <div className="about-inner-content">
                                        <img src="/images/about/img1.png" alt="image" />
                                        <p> As a Google Cloud Partner, our service spans several industries, with the main focus being Education. We provide Google Workspace technical support, sales, and training. We are passionate to see a thriving Education system, and therefore we provide unlimited access to support to our deserving Education stakeholders.</p>
                                    </div>

                                    <div className="about-inner-content">
                                        <img src="/images/about/img2.png" alt="image" />
                                        <p>Through dfeEdu, we provide schools with technologies that transform their organisations to be digitally capable.</p>
                                    </div>

                                    <div className="about-inner-content">
                                        <img src="/images/about/img3.png" alt="image" />
                                        <p>dfeMart is an Online Tech store where you can buy Tech products such as Chrome Devices, Access points, Projectors and many more .</p>
                                    </div>
                                </div>
                            </div>
                        </div>
