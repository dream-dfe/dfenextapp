                ...
                <ul className="services-list">
                    <li>
                        <Link href="/google-workspace">
                            <a className={router.pathname == "/google-workspace" ? "active": ""}> Google Workspace</a> 
                        </Link>
                    </li>
                    <li>
                        <Link href="/google-for-education">
                            <a className={router.pathname == "/google-for-education" ? "active": ""}>Google for Education </a>
                        </Link>
                    </li>
                    <li>
                        <Link href="/web">
                            <a className={router.pathname == "/web" ? "active": ""}>Web Design and Development</a>
                        </Link>
                    </li>
                    <li>
                        <Link href="/consultancy">
                            <a className={router.pathname == "/consultancy" ? "active": ""}>IT and Startup Consulting</a>
                        </Link>
                    </li>
                    <li>
                        <Link href="/cloud-computing">
                            <a className={router.pathname == "/cloud-computing" ? "active": ""}>Cloud Computing Service</a>
                        </Link>
                    </li>
                    <li>
                        <Link href="/domains">
                            <a className={router.pathname == "/domains" ? "active": ""}>Domain Hosting & Management</a>
                        </Link>
                    </li>
                </ul>
