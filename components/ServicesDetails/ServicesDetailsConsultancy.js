...
const ServicesDetailsConsultancy = () => {
    return (
        <>
                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="services-details-overview-content">
                                ...
                                <ul className="overview-list">
                                    <li>
                                        <i className="ri-check-line"></i> Business Planning
                                    </li>
                                    <li>
                                        <i className="ri-check-line"></i> Cost and Management Account
                                    </li>
                                    <li>
                                        <i className="ri-check-line"></i> Project Management
                                    </li>
                                    <li>
                                        <i className="ri-check-line"></i> Project Execution
                                    </li>
                                </ul>
...
export default ServicesDetailsConsultancy;