                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-9 col-md-12">
                            <div className="services-details-overview-content">
                                ...
                                <p>We have the ability to transform your ideas into a web app that can be built, tested and deployed online for your traget audience to see.</p>
                                
                                <ul className="overview-list">
                                    <li>
                                        <i className="ri-check-line"></i> Custom Web Applications
                                    </li>
                                    <li>
                                        <i className="ri-check-line"></i> Design, Testing and Deployment
                                    </li>
                                    <li>
                                        <i className="ri-check-line"></i> Progressive Web Applications
                                    </li>
                                    <li>
                                        <i className="ri-check-line"></i> Responsive Design
                                    </li>
                                </ul>
...
export default ServicesDetailsWeb;