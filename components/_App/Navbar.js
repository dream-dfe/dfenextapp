                                ...
                                <ul className="navbar-nav m-auto">
                                    ...
                                    <li className="nav-item">
                                        ...
                                        <ul className="dropdown-menu">
                                            <li className="nav-item">
                                                <Link href="/google-workspace" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Google Workspace</a>
                                                </Link>
                                            </li> 

                                            <li className="nav-item">
                                                <Link href="/google-for-education" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Google for Education</a>
                                                </Link>
                                            </li> 

                                            <li className="nav-item">
                                                <Link href="/web" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Web Development</a>
                                                </Link>
                                            </li> 

                                            <li className="nav-item">
                                                <Link href="/consultancy" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">IT Consulting Service</a>
                                                </Link>
                                            </li> 
                                            ...
                                            <li className="nav-item">
                                                <Link href="/domains" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Domain Hosting & Mngt</a>
                                                </Link>
                                            </li> 
                                        </ul>
                                    </li>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="sidebar-content">
                                <h3>About Us</h3>
                                <p>We are a leader in education technologies and workplace transformations in Africa.
                                     We are Google Cloud Partners who deliver customized technology and innovation solutions to more than 200 institutions and companies  </p>
                            ...
                            <div className="sidebar-contact-info">
                                ...
                                <ul className="info-list">
                                    ...
                                    <li>
                                        ...
                                        <a href="mailto:hello@ozen.com">info@dfenterprise.africa</a>
                                    </li>

                                    <li>
                                        <i className="ri-map-pin-line"></i> 
                                       370B Main Rd, Observatory <br /> Cape Town , 7925, South Africa.
                                    </li>
                                </ul>
                            </div>

                            <ul className="sidebar-social-list">
                                <li><a href="https://www.facebook.com/dreamfactoryfoundation" target="_blank"><i className="ri-facebook-fill"></i></a></li>
                                <li><a href="https://twitter.com/DreamFactoryFdn" target="_blank"><i className="ri-twitter-fill"></i></a></li>
                                <li><a href="#" target="_blank"><i className="ri-linkedin-fill"></i></a></li>
                                <li><a href="https://www.instagram.com/dreamfactory_foundation/" target="_blank"><i className="ri-instagram-fill"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
