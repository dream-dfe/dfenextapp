...
const TechSupport = () => {
    return (
        <>
            <div className="support-area">
                <div className="container">
                    <div className="support-content">
                        ...
                        <h3>Supernatural Speed</h3>
                        <p>As a start-up company, which is just a year old, we are amazed with impact we have made so far. We have a task to positively impact your cosmos!</p>
                        <span>- Lusanda Magwape, CEO Dream Factory Enterprise</span>
                    </div>
                </div>
            ...
            <style jsx>{`
                .support-area {
                    background-image: url(/images/support/lusanda-support.png);
