            ...
            <div className="blog-area pt-100 pb-70">
                <div className="container">
                    <div className="section-title">
                        <h2>Popular Blogs</h2>
                        <p>Stay up-to-date with trends in Technology and changes in the business environment</p>
                    </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-blog">
                                ...
                                <div className="blog-content">
                                    ...
                                    <h3>
                                        <Link href="#">
                                            <a>Google Classroom is the way to go towards Online Learning</a>
                                        </Link>
                                    </h3>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-blog">
                                ...
                                <div className="blog-content">
                                    ...
                                    <h3>
                                        <Link href="#">
                                            <a>Turn your old PCs and Macs into Chrome Devices .</a>
                                        </Link>
                                    </h3>
                            ...
                            <div className="single-blog">
                                ...
                                <div className="blog-content">
                                    <ul className="entry-meta">
                                        <li>
                                            <Link href="#">
                                                <a className="tag">dfeEnterprise</a>
                                            </Link>
                                        </li>
                                        <li>
                                            <i className="ri-time-line"></i>
                                    ...
                                    <h3>
                                        <Link href="#">
                                            <a>Workspace and Workplace transformation through digital tools.</a>
                                        </Link>
                                    </h3>
