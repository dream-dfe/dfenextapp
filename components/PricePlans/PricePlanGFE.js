            ...
            <div className="plans-area pt-100 pb-70">
                <div className="container">
                    <div className="section-title">
                        ...
                        <p>You can choose one or two options depending on your school needs</p>
                    </div>
                            ...
                            <TabPanel>
                                <div className="row justify-content-center">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="single-plans-table">
                                            <div className="plans-header">
                                                <h3> School Website Design and Development</h3>
                                                <p>Custom(code) or Template(Drag & drop)</p>
                                            </div>

                                            <div className="price">From R1 499 <span></span></div>
                                            ...
                                            <ul className="plans-features-list">
                                                <li><i className="ri-check-line"></i> Static Website</li>
                                                <li><i className="ri-check-line"></i> Once-off fee</li>
                                                <li><i className="ri-check-line"></i> Hosting Free for code-based sites</li>
                                                <li><i className="ri-check-line"></i> Access to Documentation</li>
                                    ...
                                    <div className="col-lg-4 col-md-6">
                                        <div className="single-plans-table active-box">
                                            <div className="plans-header">
                                                ...
                                                <p>Powerful Education Tools</p>
                                            </div>

                                            <div className="price">From R0 <span> to Deploy</span></div>
                                            ...
                                            <ul className="plans-features-list">
                                                <li><i className="ri-check-line"></i> 100TB Cloud Storage</li>
                                                <li><i className="ri-check-line"></i> Pro Google minimal</li>
                                                <li><i className="ri-check-line"></i> Google Admin Console Training</li>
                                                <li><i className="ri-check-line"></i> Week day unlimited Support</li>
                                                <li><i className="ri-check-line"></i> Mail Migrations</li>
                                            </ul>
                                    ...
                                    <div className="col-lg-4 col-md-6">
                                        <div className="single-plans-table">
                                            <div className="plans-header">
                                                <h3>Chrome Enterprise Upgrade in Education</h3>
                                                <p>Powerful & Awesome Features</p>
                                            </div>

                                            <div className="price">$** <span>/Year</span></div>
                                            ...
                                            <ul className="plans-features-list">
                                                <li><i className="ri-check-line"></i> IT Admin Support</li>
                                                <li><i className="ri-check-line"></i> Chrome OS installation</li>
                                                <li><i className="ri-check-line"></i> Provision Chrome Devices</li>
                                                <li><i className="ri-check-line"></i> Flexible Access</li>
                                                <li><i className="ri-check-line"></i> Advanced Security</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
