                        ...
                        <div className="col-lg-5 col-md-12">
                            <div className="main-banner-content">
                                ...
                                <ScrollAnimation animateIn="fadeInLeft" delay={100} animateOnce={true}>
                                    <h1>Discover endless possibilities to Tech Solutions</h1>
                                </ScrollAnimation>

                                <ScrollAnimation animateIn="fadeInLeft" delay={150} animateOnce={true}>
                                    <p> What you need for a thriving institution or business is a process being supplemented by custom tailored technology systems that we provide. 
                                        With the right technology in place, you are certainly an exceptional industry leader in your cosmos.</p>
                                </ScrollAnimation>
