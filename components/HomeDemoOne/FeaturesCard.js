                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-4 col-md-6">
                            <div className="single-features">
                                ...
                                <p>Dream Factory Enterprise (Pty) Ltd is a 100% women-owned company . It is the business arm of 
                                    <a href="https://dreamfactory.africa/" target="_blank"> Dream Factory Foundation</a>
                                    </p>

                                <div className="features-btn">
                                    <Link href="https://dreamfactory.africa/">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-features">
                                ...
                                <h3>
                                    <Link href="https://dreamfactory.africa/about/">
                                        <a >(#1BillionLives)</a>
                                    </Link>
                                </h3>
                                <p> Dream Factory Enterprise is a social enterprise, we therefore operate with dual purpose; to provide for the self-sustainability of Dream Factory Foundation.</p>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-features">
                                ...
                                <h3>
                                    <Link href="#">
                                        <a>BBBEE Compliance</a>
                                    </Link>
                                </h3>
                                <p> We take utmost pleasure in letting our clients know that doing business with us works to your advantage with our LEVEL 1 BBBEE COMPLIANCE with a 135% Score..</p>
